...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header("Location: laporan.php?status=success&message=" . urlencode("Data berhasil diperbarui!"));
    exit;
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>BizBalance - Edit Laporan Keuangan</title>
    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="laporan-entry.php"><img src="../Gambar/laporan.png" alt="" class="nav-logo">Laporan</a></li>
                <li><a href="laporan.php"><img src="../Gambar/riwayat.png" alt="" class="nav-logo">Riwayat</a></li>
        ...
        <section class="form-container">
            ...
            <form method="POST" action="">
                ...
                <div class="form-buttons">
                    ...
                    <a href="laporan.php" class="cancel-button">Batal</a>
                </div>
            </form>
        </section>
    </main>

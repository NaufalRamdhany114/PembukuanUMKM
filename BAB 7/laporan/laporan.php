...
mysqli_stmt_bind_param($stmt, 's', $userName); // Bind parameter untuk username
...
<body>
    ...
    <div class="tambah-data-container">
        <a href="laporan-entry.php" class="tambah-data-button">Tambah Data</a>
    </div>
        <table>
            <tr>
                <th>Nama</th>
            ...
            <tr>
                ...
                <td class="action-buttons">
                    <a href="laporan-edit.php?id_laporan=<?php echo $row['id_laporan']; ?>" class="edit-button">Edit</a>
                    <form action="laporan-hapus.php" method="post" style="display: inline;">
